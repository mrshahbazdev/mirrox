    ...
    return (
        <div className="lp-wrapper">
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <div className="lp-edge-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '80px', alignItems: 'center' }}>
                        <div className="lp-content-side">
                             ...
                             <h2 style={{ fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: '900', color: '#111', lineHeight: '1.1', marginBottom: '32px', textTransform: 'uppercase' }}>The <span style={{ color: 'var(--pub-red)' }}>Bulvera</span> Edge</h2>
            ...
            <section className="lp-cta-block" style={{ marginBottom: '160px' }}>
                <h2>Deploy Your Capital with Bulvera</h2>
