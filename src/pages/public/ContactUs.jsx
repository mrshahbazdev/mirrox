    ...
    return (
        <div className="fade-in">
            <section className="mb-16">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">For questions, assistance, or more information, contact Mirrox. Our customer support team is available 24/7 to provide prompt support.</p>
<p className="text-gray-600 text-lg leading-relaxed mb-4">I agree to the Terms and Conditions</p>
<p className="text-gray-600 text-lg leading-relaxed mb-4">Contact Mirrox via email for detailed assistance.</p>
<p className="text-gray-600 text-lg leading-relaxed mb-4">Get real-time customer support with our live chat feature.</p>
<p className="text-gray-600 text-lg leading-relaxed mb-4">Call us for immediate assistance.</p>
