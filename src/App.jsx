...
const AppRoutes = ({ clientId, setClientId, currentClientExtended, isAdminLoggedIn, setIsAdminLoggedIn, maintenanceMode }) => {
  ...
  const handleAdminLogout = () => {
    localStorage.removeItem('bullvera_admin_token');
    setIsAdminLoggedIn(false);
  };

  // Guard: If maintenance is ON and user is NOT admin and NOT on admin login path
  const isUserPath = location.pathname.startsWith('/app') || ['/', '/login', '/register'].includes(location.pathname);
  if (maintenanceMode && !isAdminLoggedIn && isUserPath && !location.pathname.includes('/admin')) {
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="symbols" element={<SymbolsManager />} />
        <Route path="reports" element={<Reports />} />
        <Route path="verifications" element={<Verifications />} />
        <Route path="active-traders" element={<ActiveTraders />} />
  ...
  return (
    <BrowserRouter>
      ...
      <AppRoutes
        ...
        currentClientExtended={currentClientExtended}
